...
model=pickle.load(open("ecg.bin","rb"))
...
def calculation(txt1,txt2,txt3,txt4,txt5,txt6,txt7,txt8,txt9,txt10,txt11,txt12,txt13,txt14,txt15,txt16):
    answer=model.predict([[float(txt1), float(txt2), float(txt3), float(txt4), float(txt5), float(txt6), float(txt7), float(txt8), float(txt9), float(txt10), float(txt11), float(txt12), float(txt13), float(txt14), float(txt15), float(txt16)]])
    txtoutput['text'] = getanswer(int(answer))
